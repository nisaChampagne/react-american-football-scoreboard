    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick={() => setHomeScore(homeScore+ 1) } className="homeButtons__point">Home point</button>
        ...
        <div className="awayButtons">
          ...
          <button onClick={() => setAwayScore(awayScore+ 1) } className="awayButtons__poit">Away point</button>
        </div>
      </section>
    </div>
  );
